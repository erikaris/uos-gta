...
```{=html}
<iframe class="slide-deck" src="../slides/week-4.html" height="420" width="747" style="border: 1px solid #2e3846;"></iframe>
```
...
#| warning: false
#| autorun: true
rio2016Medals<-read_csv("data/Rio2016.csv") # default separator is ','
