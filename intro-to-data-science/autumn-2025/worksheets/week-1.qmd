...
webr:
  ...
  resources:
    - https://raw.githubusercontent.com/erikaris/uos-gta/refs/heads/main/datasets/tempnormals.csv
---
...
#| edit: false
#| warning: false
temperatures <-  read_csv("https://erikaris.github.io/uos-gta/datasets/tempnormals.csv") |>
  mutate(
    location = factor(
