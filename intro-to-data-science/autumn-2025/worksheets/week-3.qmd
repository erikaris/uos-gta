...
webr:
  ...
  resources:
    ...
    - "https://raw.githubusercontent.com/erikaris/uos-gta/refs/heads/main/datasets/indicator hiv estimated prevalence% 15-49.xlsx"
...
Exercise prompt: Using the visualisations you saw previously, explore the two datasets you have loaded (the free school meals and the HIV prevalence). For example, compare the distribution of HIV prevalence across different years using side-by-side histograms.
